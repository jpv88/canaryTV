...
struct GetTrailerURL: Requestable {
    ...
    init(movieID: String, languageID: String, subtitleID: String) {
        ...
        let specificQueryItems: [URLQueryItem] = [
            ...
            URLQueryItem(name: "subtitle_language", value: subtitleID),
